...
f = imread('degarded_text.png');                                  % Reading the image
% f = rgb2gray(f);
...
WinSize = 9;                                               % Window Size
K_Sauvola = 0.2;                                            % Sauvola coefficient
% K_Niblack = 0.2;                                           % Niblack coefficient
R=74;
%%%% at the first you write  R=127
K_Niblack = -0.2;                                           % Niblack coefficient
...
for m=L+1:M-L
     for n=L+1:N-L
         ...
         Threshold = Mean * (1 - K_Sauvola*(1-Std_zig/R) );   % Calculating Sauvola threshold
...
for m=L+1:M-L
     for n=L+1:N-L
         %%%% I write these variables to track indice
         ind_x_1 = m+L; ind_y_1 = n+L;
         ind_x_2 = m+L; ind_y_2 = n-L; %%% I think you should write , m-L-1 & n-L-1
         ind_x_3 = m-L; ind_y_3 = n+L;
         ind_x_4 = m-L; ind_y_4 = n-L; 
         %%%% with this method you chose 6*6 matrix
